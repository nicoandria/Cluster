<?php require('../inc/model.php'); 
    $total=find("sum(total_sales)","sales_by_film_category",null);
    $totalParMagasin=find(null,"sales_by_store",null);
?>
<!doctype html>
<html>
...
<![endif]-->
    ...
    <li>
        ...
        <div class="stat_text">
        <strong><?php echo($total[0][0]); ?>$</strong>Montant de vente total
        </div>
    </li>
     <?php for($i=0;$i<count($totalParMagasin);$i++){ ?>
        <li>
        <div class="sparkline pie_week"></div>
        <div class="stat_text">
        <strong><?php echo($totalParMagasin[$i][2]); ?>$</strong><?php echo($totalParMagasin[$i][0]); ?>
        </div>
    </li>
        <?php } ?>
    </ul>
