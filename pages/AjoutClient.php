        ...
        <div id="div-1" class="body">
            <form class="form-horizontal" action="addClient.php" method="POST">
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" name="store" placeholder="Store" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" name="adressid" placeholder="Adress ID" class="form-control">
                    </div>
                </div>
                 <div class="form-group">
                    <label for="text1" class="control-label col-lg-4">Active</label>
                    <div class="col-lg-8">
                        <input type="text" name="active" placeholder="Active" class="form-control">
                    </div>
                </div>
